...
const PLANES = [
  ...
  },
  {
    ...
    badgeColor: GOLD,
    destacado: true,
    descripcion: 'Para el ingeniero independiente que necesita informes profesionales verificables y respaldo normativo completo.',
    features: [
      '1 usuario',
      '15 módulos de ingeniería',
    ...
    cta:     'Suscribirse',
    ctaHref: `mailto:${MAIL}?subject=Plan Pro INGENIUM PRO&body=Hola, quiero suscribirme al Plan Pro (USD 79/mes).`,
    ctaMail: true,
  },
  {
    id:        'team',
    ...
    cta:     'Contratar Team',
    ctaHref: `mailto:${MAIL}?subject=Plan Team INGENIUM PRO&body=Hola, quiero contratar el Plan Team (USD 199/mes).`,
    ctaMail: true,
  },
  {
    id:        'enterprise',
    ...
    ctaHref: `mailto:${MAIL}?subject=Plan Enterprise INGENIUM PRO&body=Hola, quiero consultar el Plan Enterprise (USD 499/mes).`,
    ctaMail: true,
  },
];
