...
export const metadata: Metadata = {
  ...
  description:
    ...
    'Acceso a 18 módulos de ingeniería industrial con PDF verificable, Excel y DXF. ' +
  ...
  openGraph: {
    title: 'Planes y Precios — INGENIUM PRO',
    description:
      'Módulo único, Dúo, Pro o Team. 18 módulos de ingeniería, PDF verificable, Excel y DXF.',
