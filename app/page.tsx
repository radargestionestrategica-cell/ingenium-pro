      ...
      <section id="modulos" className="section section-alt">
        <div className="wrap">
          ...
          <div style={{ textAlign: 'center', marginTop: 28 }}>
            <a href="/modulos" className="btn-secondary">Ver módulos y capacidades avanzadas →</a>
          </div>
        </div>
      </section>
