...
// tipo real de cálculo -> moduloId canónico del dashboard (mapa compartido
// con exportar/route.ts; contenido sin cambios respecto de la versión local)
import { TIPO_A_MODULO } from '@/lib/tipos-calculo'
