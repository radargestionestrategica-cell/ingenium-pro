...
// ═══════════════════════════════════════════════════════════════
//  INGENIUM PRO v8.1 — DASHBOARD — 15 MÓDULOS TÉCNICOS
//  Silvana Belén Colombo © 2026 — RADAR Gestión Estratégica
// ═══════════════════════════════════════════════════════════════
...
const MODULOS = [
  {
    id: 'petroleo',
    titulo: 'Petróleo & Gas',
    desc: 'MAOP, Barlow, factor E·T, análisis riesgo',
    icono: '🛢️',
    color: '#f59e0b',
    norma: 'ASME B31.8 · API 5L · API 1104',
  },
  {
    id: 'hidraulica',
    titulo: 'Hidráulica',
    desc: 'Darcy-Weisbach, Joukowsky, golpe de ariete',
    icono: '💧',
    color: '#06b6d4',
    norma: 'AWWA M11 · ASME B31.3',
  },
  {
    id: 'perforacion',
    titulo: 'Perforación',
    desc: 'Lodo, ECD, gradiente fractura, Eaton',
    icono: '⛏️',
    color: '#8b5cf6',
    norma: 'API RP 13D · API RP 7G · DNV',
  },
  {
    id: 'mineria',
    titulo: 'Minería',
    desc: 'RMR Bieniawski, UCS, voladura, ventilación',
    icono: '🪨',
    color: '#ef4444',
    norma: 'Bieniawski (1989) · MSHA · ISO',
  },
  {
    id: 'civil',
    titulo: 'Ingeniería Civil',
    desc: 'Perfiles W, vigas, columnas, cargas',
    icono: '🏗️',
    color: '#3b82f6',
    norma: 'AISC 360 · ACI 318 · CIRSOC 301',
  },
  {
    id: 'geotecnia',
    titulo: 'Geotecnia',
    desc: 'Portante Meyerhof, Bishop, nivel freático',
    icono: '🌍',
    color: '#a16207',
    norma: 'Meyerhof (1963) · CIRSOC 101',
  },
  {
    id: 'termica',
    titulo: 'Térmica',
    desc: 'LMTD, intercambiadores, dilatación',
    icono: '🌡️',
    color: '#dc2626',
    norma: 'TEMA · ASME Sec.VIII · Kern (1950)',
  },
  {
    id: 'vialidad',
    titulo: 'Vialidad',
    desc: 'AASHTO 93, pavimento flexible/rígido',
    icono: '🛣️',
    color: '#16a34a',
    norma: 'AASHTO Guide 1993 · Manual DG-2018',
  },
  {
    id: 'arquitectura',
    titulo: 'Arquitectura Técnica',
    desc: 'Cargas de viento, sismo, ASCE 7-22',
    icono: '🏛️',
    color: '#0891b2',
    norma: 'ASCE 7-22 · CIRSOC 103 · NSR-10',
  },
  {
    id: 'represas',
    titulo: 'Represas & Presas',
    desc: 'Francis, Darcy filtraciones, Terzaghi',
    icono: '🏞️',
    color: '#0284c7',
    norma: 'USACE EM 1110-2 · ICOLD',
  },
  {
    id: 'soldadura',
    titulo: 'Soldadura',
    desc: 'Electrodos, Heat Input, filete, CE precal.',
    icono: '⚡',
    color: '#d97706',
    norma: 'AWS D1.1:2020 · ASME Sec.IX · API 1104',
  },
  {
    id: 'mmo',
    titulo: 'Maestro Mayor de Obra',
    desc: 'Hormigón, hierro, mampostería, losas, zapata',
    icono: '🧱',
    color: '#10b981',
    norma: 'CIRSOC 201 · ACI 318 · NCh 170 · NSR-10',
  },
  {
    id: 'electricidad',
    titulo: 'Electricidad Industrial',
    desc: 'Cable, CC, FP, motor, área peligrosa, lux',
    icono: '🔋',
    color: '#22c55e',
    norma: 'NEC 2023 · IEC 60909 · API RP 500 · IEC 60079',
  },
  {
    id: 'canerias',
    titulo: 'Cañerías e Integridad',
    desc: 'Espesor B31.8/B31.4, Hoop Stress, ariete, vida remanente',
    icono: '🔧',
    color: '#f97316',
    norma: 'ASME B31.8 · ASME B31.4 · API 579 · Joukowsky',
  },
  {
    id: 'valvulas',
    titulo: 'Válvulas Industriales',
    desc: 'Clase B16.34, material NACE, brida B16.5, Cv, DXF',
    icono: '⚙️',
    color: '#0d9488',
    norma: 'ASME B16.34 · ASME B16.5 · ISA 75.01 · NACE MR0175',
  },
];
...
export default function Dashboard() {
  ...
  const hablarEstado = () => {
    ...
    const texto = `Bienvenido, ${usuario?.nombre.split(' ')[0]}. INGENIUM PRO versión 8.1 operativa. Sistema de medidas configurado en ${sistemaMedidas}. Seleccione un módulo para comenzar.`;
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#070d1a', fontFamily: 'Inter, system-ui, sans-serif', color: '#f1f5f9' }}>
      ...
      <header style={{ background: 'rgba(7,13,26,0.98)', borderBottom: '1px solid rgba(99,102,241,0.25)', padding: '12px 24px', display: 'flex', alignItems: 'center', gap: 12, position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        <button
          onClick={leyendo ? () => window.speechSynthesis.cancel() : hablarEstado}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <button
            ...
            style={{ padding: '6px 14px', background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: 8, color: '#f87171', fontSize: 11, cursor: 'pointer', fontWeight: 600 }}>
            Salir
          </button>
        </div>
      </header>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 14, color: '#475569', margin: 0 }}>
            Cálculos configurados en {sistemaMedidas}. Seleccioná un módulo:
          </p>
        </div>

        {/* ── BOTÓN CHAT IA ──────────────────────────────── */}
        <div
          onClick={() => router.push(`/?modulo=chat&sys=${sistemaMedidas}`)}
        ...
        <div style={{ fontSize: 11, color: '#334155', fontWeight: 700, letterSpacing: 1, marginBottom: 16, textTransform: 'uppercase' }}>
          15 Módulos Técnicos — Normativas Reales Verificadas
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 16 }}>
          {MODULOS.map(m => (
            <div
              key={m.id}
              onClick={() => router.push(`/?modulo=${m.id}&sys=${sistemaMedidas}`)}
              style={{ background: 'rgba(15,23,42,0.8)', border: `1px solid ${m.color}20`, borderRadius: 16, padding: '20px', cursor: 'pointer', position: 'relative', overflow: 'hidden', transition: 'border-color 0.2s' }}>
              <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 3, background: m.color, borderRadius: '16px 16px 0 0' }} />
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                <div style={{ width: 44, height: 44, borderRadius: 12, background: `${m.color}15`, border: `1px solid ${m.color}30`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>
                  {m.icono}
                </div>
        ...
        <div style={{ marginTop: 48, textAlign: 'center', color: '#1e293b', fontSize: 10 }}>
          INGENIUM PRO v8.1 · 15 Módulos · Normativas Reales Verificadas · © 2026 Silvana Belén Colombo · RADAR Gestión Estratégica
        </div>
      </div>
    </div>
  );
