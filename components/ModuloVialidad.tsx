  ...
  const calcDren = () => {
    ...
    const payload: DatosExportar = {
      ...
      dxfParams: {
        ...
        y_m:          r.y_m,
        V_cuneta:     r.V_cuneta,
        T_superficie: r.T_superficie,
        A_ha:         parseFloat(A_ha),
        C_val:        parseFloat(C_val),
        I_val:        parseFloat(I_val),
        L_cuneta:     parseFloat(L_cun),
        Z1:           parseFloat(Z1_val),
        Z2:           parseFloat(Z2_val),
        n_manning:    parseFloat(n_val),
        S:            parseFloat(S_val),
        ok_velocidad: r.ok_velocidad,
        riesgo:       r.riesgo,
      },
    };
