  ...
  const calcViento = () => {
    ...
    const payload: DatosExportar = {
      ...
      dxfParams: {
        ...
        h_m: parseFloat(h_m), expo,
        Kz: r.Kz, qz_kPa: r.qz_kPa,
        p_barlovento: r.p_barlovento_kPa, p_sotavento: r.p_sotavento_kPa,
        p_total: r.p_total_kPa, riesgo: r.riesgo,
      },
    };
  ...
  const calcIlum = () => {
    ...
    const payload: DatosExportar = {
      ...
      dxfParams: {
        ...
        alto_m: parseFloat(alto), A_vent_m2: parseFloat(A_vent),
        FLD: r.FLD, FLD_req: r.FLD_req, RVP: r.RVP,
        Q_ventilacion: r.Q_ventilacion_m3h, renovaciones_h: r.renovaciones_h,
        ok_fld: r.ok_fld, ok_rvp: r.ok_rvp, uso_loc, riesgo: r.riesgo,
      },
    };
  ...
  const calcSismo_ = () => {
    ...
    const payload: DatosExportar = {
      ...
      dxfParams: {
        ...
        zona, suelo_tipo: suelo,
        T: r.T, a0: r.a0, S: r.S, Sa: r.Sa,
        Cs: r.Cs, V_kN: r.V_kN, R: parseFloat(R_red),
        riesgo: r.riesgo,
      },
    };
