...
const ACCESOS = [
  ...
  { id:'electromecanica_flota', label:'Electromecánica de Flota Pesada', icon:'🚛', color:'#34d399', norma:'SAE/API/ASME · IEC/ISO' },
];

const CAPACIDADES = [
  { icon:'📐', titulo:'18 módulos técnicos', desc:'Petróleo · Electricidad · Civil · Minería · Represas · Soldadura y más' },
    ...
    <div style={{ padding:'32px 28px', maxWidth:1080, margin:'0 auto' }}>
      ...
      <div style={{
        ...
        <div style={{ display:'flex', alignItems:'flex-start', gap:20, flexWrap:'wrap' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, flexShrink:0 }}>
            {[
              { val:'18',   lbl:'Módulos activos', color:GOLD  },
      ...
      <div style={{ marginBottom:8 }}>
        <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:16 }}>
          ...
          <div style={{ fontSize:10, color:'#334155', fontWeight:600 }}>18 módulos disponibles</div>
        </div>
