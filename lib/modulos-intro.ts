...
export const MODULOS_INTRO: Record<string, ModuloIntroData> = {
  ...
  valvulas: {
    ...
    que_calcula: ['Clase de presión mínima — B16.34: WCB Tabla 2-1.1 (Class 150 a 2500), CF8M Tabla 2-2.2 (Class 150 a 600); prueba hidrostática de carcasa y duración (§7.1.1 / §7.1.2)', 'Material cuerpo: WCB, CF8M, WC6 según temperatura, fluido e H₂S (NACE MR0175)', 'Dimensiones brida B16.5: OD, círculo pernos, N° pernos y bore (NPS ½" a 24")', 'Coeficiente de caudal Cv (líquidos) — ISA-75.01.01-2012 / IEC 60534-2-1: Kv = Q × √(SG / ΔP), Cv = 1,156 × Kv, con verificación de flujo estrangulado', 'Plano DXF — 2D con brida dimensionada para AutoCAD / FreeCAD'],
    que_calcula_en: ['Minimum pressure class — B16.34: WCB Table 2-1.1 (Class 150 to 2500), CF8M Table 2-2.2 (Class 150 to 600); shell hydrostatic test pressure and duration (§7.1.1 / §7.1.2)', 'Body material: WCB, CF8M, WC6 by temperature, fluid, and H₂S (NACE MR0175)', 'B16.5 flange dimensions: OD, bolt circle, number of bolts, bore (NPS ½" to 24")', 'Flow coefficient Cv (liquids) — ISA-75.01.01-2012 / IEC 60534-2-1: Kv = Q × √(SG / ΔP), Cv = 1.156 × Kv, with choked-flow check', 'DXF drawing — 2D dimensioned flange for AutoCAD / FreeCAD'],
    normativas: ['ASME B16.34 — Valves: Flanged, Threaded and Welding End', 'ASME B16.5-2017 — Pipe Flanges and Flanged Fittings', 'ISA-75.01.01-2012 / IEC 60534-2-1 — Flow Equations for Sizing Control Valves', 'NACE MR0175/ISO 15156 — Sour Service Material Requirements'],
  ...
  // ────────────────────────────────────────────────────────────
  gistm: {
    color: '#38bdf8', icono: '⛰️',
    titulo: { es:'GISTM - Gestión de Relaves', en:'GISTM - Tailings Management', pt:'GISTM - Gestão de Rejeitos', ar:'GISTM - إدارة المخلفات المنجمية', fr:'GISTM - Gestion des Résidus Miniers', ru:'GISTM - Управление Хвостохранилищами', zh:'GISTM - 尾矿管理', id:'GISTM - Manajemen Tailing' },
    que_es: {
      es: 'Checklist de conformidad con el Global Industry Standard on Tailings Management (GISTM), publicado por ICMM, UNEP y PRI en agosto de 2020. Evalúa el cumplimiento de los depósitos de relaves mineros frente a los requisitos auditables del estándar, cubriendo comunidades afectadas, base de conocimiento técnica, diseño y construcción, gobernanza, respuesta a emergencias y divulgación pública.',
      en: 'Conformance checklist for the Global Industry Standard on Tailings Management (GISTM), published by ICMM, UNEP and PRI in August 2020. Assesses compliance of mine tailings facilities against the standard\'s auditable requirements, covering affected communities, technical knowledge base, design and construction, governance, emergency response, and public disclosure.',
      pt: 'Checklist de conformidade com o Global Industry Standard on Tailings Management (GISTM), publicado pelo ICMM, UNEP e PRI em agosto de 2020. Avalia o cumprimento dos depósitos de rejeitos de mineração frente aos requisitos auditáveis do padrão, cobrindo comunidades afetadas, base de conhecimento técnico, projeto e construção, governança, resposta a emergências e divulgação pública.',
      ar: 'قائمة تحقق للامتثال للمعيار الصناعي العالمي لإدارة المخلفات المنجمية (GISTM)، الصادر عن ICMM وUNEP وPRI في أغسطس 2020. يقيّم امتثال مرافق مخلفات التعدين لمتطلبات المعيار القابلة للتدقيق، ويغطي المجتمعات المتأثرة وقاعدة المعرفة التقنية والتصميم والبناء والحوكمة والاستجابة للطوارئ والإفصاح العام.',
      fr: 'Liste de conformité au Global Industry Standard on Tailings Management (GISTM), publié par l\'ICMM, le PNUE et le PRI en août 2020. Évalue la conformité des installations de résidus miniers aux exigences auditables de la norme, couvrant les communautés affectées, la base de connaissances techniques, la conception et la construction, la gouvernance, la réponse aux urgences et la divulgation publique.',
      ru: 'Чек-лист соответствия Глобальному отраслевому стандарту управления хвостохранилищами (GISTM), опубликованному ICMM, ЮНЕП и PRI в августе 2020 года. Оценивает соответствие хвостохранилищ проверяемым требованиям стандарта, охватывающим затронутые сообщества, базу технических знаний, проектирование и строительство, управление, реагирование на чрезвычайные ситуации и публичное раскрытие информации.',
      zh: '全球尾矿管理行业标准（GISTM）合规检查清单，由ICMM、UNEP和PRI于2020年8月发布。评估矿山尾矿设施对该标准可审计要求的符合情况，涵盖受影响社区、技术知识库、设计与施工、治理、应急响应和公开披露。',
      id: 'Daftar periksa kepatuhan terhadap Global Industry Standard on Tailings Management (GISTM), diterbitkan oleh ICMM, UNEP, dan PRI pada Agustus 2020. Menilai kepatuhan fasilitas tailing tambang terhadap persyaratan standar yang dapat diaudit, mencakup masyarakat terdampak, basis pengetahuan teknis, desain dan konstruksi, tata kelola, tanggap darurat, dan pengungkapan publik.',
    },
    que_calcula: ['Evaluación de conformidad de 77 requisitos auditables agrupados en 15 Principles', 'Cobertura de los 6 Topics del estándar: comunidades afectadas, base de conocimiento, diseño/construcción/operación, gestión y gobernanza, respuesta a emergencias, divulgación pública', 'Estado por requisito: Cumple / No cumple / No aplica, con justificación y evidencia de respaldo', 'Trazabilidad por Principle y Topic para auditoría interna o de terceros'],
    que_calcula_en: ['Conformance assessment of 77 auditable requirements grouped into 15 Principles', "Coverage of the standard's 6 Topics: affected communities, knowledge base, design/construction/operation, management and governance, emergency response, public disclosure", 'Per-requirement status: Compliant / Non-compliant / Not applicable, with supporting justification and evidence', 'Traceability by Principle and Topic for internal or third-party audit'],
    normativas: ['ICMM/UNEP/PRI - GISTM (agosto 2020)'],
