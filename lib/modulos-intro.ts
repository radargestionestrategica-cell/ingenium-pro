...
export const MODULOS_INTRO: Record<string, ModuloIntroData> = {
  ...
  valvulas: {
    ...
    que_calcula_en: ['Minimum pressure class: Class 150/300/600/900/1500/2500 — B16.34 Table 2-1.1', 'Body material: WCB, CF8M, WC6 by temperature, fluid, and H₂S (NACE MR0175)', 'B16.5 flange dimensions: OD, bolt circle, number of bolts, bore (NPS ½" to 24")', 'Flow coefficient Cv (liquids) — ISA-75.01.01-2012 / IEC 60534-2-1: Kv = Q × √(SG / ΔP), Cv = 1.156 × Kv, with choked-flow check', 'DXF drawing — 2D dimensioned flange for AutoCAD / FreeCAD'],
    normativas: ['ASME B16.34-2017 — Valves: Flanged, Threaded and Welding End', 'ASME B16.5-2017 — Pipe Flanges and Flanged Fittings', 'ISA-75.01.01-2012 / IEC 60534-2-1 — Flow Equations for Sizing Control Valves', 'NACE MR0175/ISO 15156 — Sour Service Material Requirements'],
