...
export const PRINCIPLES_GISTM: Principle[] = [
  ...
  },
  {
    ...
    tituloEs:
      'Divulgar públicamente y proporcionar acceso a información sobre la instalación de relaves para respaldar la rendición de cuentas pública.',
    requisitos: [
      {
        id: '15.1',
        principleId: 15,
        ...
        textoEs:
          'Publicar y actualizar regularmente información sobre el compromiso del Operador con la gestión segura de la instalación de relaves, la implementación de su marco de gobernanza de relaves, y sus políticas, estándares o enfoques a nivel organizacional para el diseño, la construcción, el monitoreo y el cierre de instalaciones de relaves. A. Para instalaciones de relaves nuevas para las cuales el proceso de autorización regulatoria haya comenzado, o que hayan sido aprobadas de otro modo por el Operador, el Operador deberá publicar y actualizar, de conformidad con el Principio 21 de los UNGP (Principios Rectores de las Naciones Unidas sobre las Empresas y los Derechos Humanos), la siguiente información: 1. Un resumen en lenguaje sencillo de los fundamentos de la base del diseño y del sitio seleccionado según el análisis multicriterio de alternativas, las evaluaciones de impacto y los planes de mitigación (la información puede obtenerse del resultado de múltiples Requisitos, incluyendo, entre otros, los Requisitos 3.2, 3.3, 5.1, 5.3, 6.4, 6.6, 7.1 y 10.1); y 2. La Clasificación de Consecuencia (Requisito 4.1). B. Para cada instalación de relaves existente, y de conformidad con el Principio 21 de los UNGP, el Operador deberá publicar y actualizar, al menos de forma anual, la siguiente información: 1. Una descripción de la instalación de relaves (Requisitos 5.5 y 6.4); 2. La Clasificación de Consecuencia (Requisito 4.1); 3. Un resumen de los hallazgos de la evaluación de riesgos relevantes (Requisito 10.1); 4. Un resumen de las evaluaciones de impacto y de la exposición y vulnerabilidad humana ante escenarios creíbles de falla por flujo (Requisitos 2.4 y 3.3); 5. Una descripción del diseño para todas las fases del ciclo de vida, incluyendo la altura actual y la altura final (Requisito 5.5); 6. Un resumen de los hallazgos materiales de las revisiones de desempeño anuales y de la Revisión de Seguridad de la Presa (DSR), incluyendo la implementación de medidas de mitigación para reducir el riesgo a ALARP (Requisitos 10.4 y 10.5); 7. Un resumen de los hallazgos materiales del programa de monitoreo ambiental y social, incluyendo medidas de mitigación (Requisito 7.5); 8. Una versión resumida del Plan de Preparación y Respuesta ante Emergencias (EPRP), para instalaciones con modo(s) de falla creíble que pudieran derivar en un evento de falla por flujo, que: (i) esté informada por los escenarios creíbles del análisis de rotura; (ii) incluya medidas de respuesta a emergencias que apliquen a las personas afectadas por el proyecto e involucre cooperación con agencias del sector público; y (iii) excluya detalles de medidas de preparación que apliquen a los activos del Operador, o información confidencial (Requisitos 13.1 y 13.2); 9. Fechas de las revisiones independientes más recientes y próximas (Requisito 10.5); y 10. Confirmación anual de que el Operador cuenta con capacidad financiera adecuada (incluyendo seguro, en la medida comercialmente razonable) para cubrir los costos estimados de cierre planificado, cierre anticipado, recuperación y cierre posterior de la instalación y sus estructuras conexas (Requisito 10.7). Dichas divulgaciones deberán realizarse de forma directa, salvo limitaciones impuestas por las autoridades regulatorias. C. Proporcionar a las autoridades locales y servicios de emergencia información suficiente derivada del análisis de rotura para permitir una planificación eficaz de gestión de desastres (Requisito 2.3).',
      },
      {
        id: '15.2',
        principleId: 15,
        ...
        textoEs:
          'Responder de manera sistemática y oportuna a las solicitudes de partes interesadas y afectadas que requieran información adicional relevante para la seguridad pública y la integridad de una instalación de relaves. Cuando se deniegue una solicitud de información, proporcionar una explicación a la parte interesada solicitante.',
      },
      {
        id: '15.3',
        principleId: 15,
        ...
        textoEs:
          'Comprometerse a cooperar en iniciativas creíbles de transparencia global para crear bases de datos, inventarios u otros repositorios de información estandarizados, independientes, de alcance sectorial y de acceso público, sobre la seguridad e integridad de las instalaciones de relaves.',
      },
    ],
  },
];
